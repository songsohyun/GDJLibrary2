...
public class PageUtils3 {
	...
	*****************************************************************************/
	...
	private int recordPerPage = 12;  // 여기서 마음대로 정한다.
	...
	*****************************************************************************/
	...
	// page : 파라미터로 가져온다.
	public void setPageEntity(int totalRecord, int page, int recordPerPage) {
	...
	// ◀◀  prev  1  2  3  4  5  next  ▶▶
	public String getPaging(String path, int recordPerPage) {
		...
		if(page <= pagePerBlock) {
			...
			sb.append("<a class=\"link\" href=\"" + path + "page=" + (beginPage - 1) + "&value=" + recordPerPage + "\"><i class=\"fa-solid fa-backward\"></i></a>");
		}
		...
		if(page == 1) {
			...
			sb.append("<a class=\"link\" href=\"" + path + "page=" + (page - 1) + "&value=" + recordPerPage + "\">prev</a>");
		}
		...
		for(int p = beginPage; p <= endPage; p++) {
			if(p == page) {
				...
				sb.append("<a class=\"link\" href=\"" + path + "page=" + p + "&value=" + recordPerPage + "\">" + p + "</a>");
			}
		}
		...
		if(page == totalPage) {
			...
			sb.append("<a class=\"link\" href=\"" + path + "page=" + (page + 1) + "&value=" + recordPerPage + "\">next</a>");
		}
		...
		if(endPage == totalPage) {
			...
			sb.append("<a class=\"link\" href=\"" + path + "page=" + (endPage + 1) + "&value=" + recordPerPage + "\"><i class=\"fa-solid fa-forward\"></i></a>");
		}

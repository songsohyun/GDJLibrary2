	...
	<div class="container">
		...
		<div class="agree">
			<div>
	            ...
	            이용자는 변경된 약관에 동의하지 않을 경우 서비스 이용을 중단하고 본인의 회원등록을 취소할 수 있으 며, 계속 사용하는 경우에는 약관 변경에 동의한 것으로 간주되며 변경된 약관은 전항과 같은 방법으로 효력 이 발생한다.<br>
	            이용자가 이 약관의 내용에 동의하는 경우 GDJLibrary의 서비스 제공행위 및 이용자의 서비스 이용행위에는 이 약관이 우선적으로 적용된다.<br>
	            이 약관에 명시되지 않은 사항에 대해서는 전기통신기본법, 전기 통신사업법, 정보통신망이용촉진및정보보호등에관한법률, 정보통신윤리위원회 심의규정, 정보통신 윤리강령, 프로그램 보호법 등 기타 대한민국의 관련법령과 상관습에 의한다.<br>
	            <br>
	            제3조 용어의 정의<br>
	            이 약관에서 사용하는 용어의 정의는 다음과 같다.<br>
	            이용자 : 서비스에 접속하여 도서관 통합홈페이지가 제공하는 서비스를 받는 회원<br>
	            회원 : 서비스에 접속하여 이 약관에 동의하고, ID(아이디)와 PASSWORD(비밀번호)를 발급 받아 실명확인 절차를 거친 자<br>
	            ...
	            제6조 이용신청의 승낙<br>
	            도서관 통합홈페이지 관리자는 제5조에서 정한 사항을 정확히 기재하여 이용신청을 하였을 경우 특별한 사정이 없는 한 서비스 이용신청을 승낙한다.<br>
	            도서관 통합홈페이지 관리자는 다음 각 호에 해당하는 경우에 대하여는 그 신청에 대한 제한 사유가 해소될 때까지 승낙 을 유보 또는 일부 서비스 이용을 제한할 수 있다.<br>
	            내용이 허위(차명, 비실명, 도용 등)인 것으로 판명되거나, 그러하다고 의심할만한 합리적 인 사유가 발생할 경우<br>
	            기타 GDJLibrary가 필요하다고 인정되는 경우<br>
	            <br>

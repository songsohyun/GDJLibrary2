...
<body>
   ...
   <section class="clearfix2">
	    ...
	    <div class="container2">
	        <ul>
	            <li><a href="${contextPath}/admin/listMember?value=5">활동회원관리</a></li>
	            <li><a href="${contextPath}/admin/listDormantMember?value=5">휴면회원관리</a></li>
	            <li><a href="${contextPath}/admin/listSignOutMember?value=5">탈퇴회원관리</a></li>
	            <li><a href="${contextPath}/admin/listBook?value=5">도서관리</a></li>
